...
var result_1 = calculate_Factorial(5);
var result_2 = calculate_Factorial(4);
...
function convert_To_Binary(num_1) {
    var binary = " ";
    while (num_1 > 0) {
        var remainder = num_1 % 2;
...
;
var new_Result = convert_To_Binary(10);
var new_Result_1 = convert_To_Binary(5);
